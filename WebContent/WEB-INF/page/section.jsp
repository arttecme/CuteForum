...
<div class="row">
	<div class="col-xs-3">
		<span class="txtColorDark txtBold">【${section.title}】</span>板块共有话题${topicsNum}个
	</div>
	<div class="col-xs-9">
...
pl.linkBody = pageContext.getAttribute("rt") + "/section.action?id=" + request.getAttribute("id") + "&";
...
function jumpPage()
{
	...
	var link = "${rt}/section.action?id=${requestScope.id}&page="+input;
	location.href = link;
